...
export default function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-16 sm:py-20 px-4 sm:px-6 relative" ref={ref}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-lg border border-white/10 bg-surface-100/70 p-6 hover:border-primary-400/40 transition-all duration-300 backdrop-blur-md"
            >
